  ...
  function boot() {
    ...
    work
      .then(function (data) {
        ...
        if (type === "project") {
          renderProject(data);
          return loadScript("js/main.js?v=20260714g").then(function () { return loadScript("js/audio-player.js"); });
        }
        if (type === "home") {
          renderHome(data);
          return loadScript("js/main.js?v=20260714g").then(function () { return loadScript("js/home.js?v=20260714b"); });
        }
      })
      .catch(function (err) {
