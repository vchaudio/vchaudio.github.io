(function () {
  ...
  /* ============================== Resume editor ============================== */
  /* Build a print-ready CV HTML document from the resume data, mirroring the
     hand-written cv-print.html (the source for scripts/build-cv-pdf.ps1) but
     data-driven. assetBase is the site root URL used to resolve relative asset
     paths (avatar) when the document is opened from the admin. Edit the markup
     / <style> below to restyle the PDF — this is the "converter" the admin runs. */
